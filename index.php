...
<!-- temporarily cut out images paste back here if needed -->
    ...
    <div class="section full-width-portfolio" style="border-top:0; border-bottom:0; background:#fff;">
      ...
      <ul data-animated="fadeIn">
        <li>
<div class="fb-video" data-href="<?php echo $vid; ?>"  data-show-text="false"><p><?php echo "<h3>".$description."</h3>"; ?></p><blockquote cite="<?php echo $vid; ?>" class="fb-xfbml-parse-ignore"><a href="<?php echo $vid; ?>"></a><p><?php echo $description; ?></p>Posted by <a href="https://www.facebook.com/loris.lovely.lashes.muncie/">Lori&#039;s Lovely Lashes</a> on Monday, February 12, 2018</blockquote></div>
        </li>
      </ul>
    </div>
